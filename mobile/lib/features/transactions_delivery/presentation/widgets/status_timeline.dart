          ...
          return Row(
            ...
            children: [
              SizedBox(
                ...
                child: Column(
                  children: [
                    const Icon(Icons.check_circle, color: AppColors.ecoGreen, size: 20),
                    if (!last) Container(width: 2, height: 52, color: AppColors.mintGreen),
                  ],
                ),
              ),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(item.statusName, style: Theme.of(context).textTheme.titleSmall),
